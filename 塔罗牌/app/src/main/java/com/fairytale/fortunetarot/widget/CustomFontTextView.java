...
public class CustomFontTextView extends AppCompatTextView {
    ...
    private void initView(Context context,AttributeSet attrs){
        ...
        String font = array.getString(R.styleable.CustomFontTextView_customFont);
        boolean isBold = array.getBoolean(R.styleable.CustomFontTextView_isBold,false);
        String tag = array.getString(R.styleable.CustomFontTextView_departTag);
        int departByPos = array.getInt(R.styleable.CustomFontTextView_departByPos,0);
        array.recycle();
