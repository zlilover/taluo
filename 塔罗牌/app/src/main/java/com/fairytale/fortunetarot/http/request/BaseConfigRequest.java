...
public class BaseConfigRequest extends BaseRequest {
    ...
    public void getBaseConfig(final Context context) {
        observe(mBaseConfigService.getBaseConfig()).subscribe(new Action1<BaseConfigEntity>() {
            @Override
            public void call(BaseConfigEntity baseConfigEntityResponse) {
                ...
                SPUtil.put(context,"isGoodOpinion",baseConfigEntityResponse.getIshaoping());
            }
        });
    }
